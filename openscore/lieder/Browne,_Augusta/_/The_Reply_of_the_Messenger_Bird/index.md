...
- [MuseScore 4 (compressed)](https://fourscoreandmore.org/openscore/lieder/Browne,_Augusta/_/The_Reply_of_the_Messenger_Bird.mscz).
- [MusicXML (compressed)](https://fourscoreandmore.org/openscore/lieder/Browne,_Augusta/_/The_Reply_of_the_Messenger_Bird.mxl). Use this version to open the file in other notation apps.
- [MuseScore 3 (uncompressed)](https://raw.githubusercontent.com/OpenScore/Lieder/refs/heads/main/scores/Browne,_Augusta/_/The_Reply_of_the_Messenger_Bird/lc6588799.mscx). This is the version as transcribed by our team (with no updates etc.). It is uncompressed (so a larger file).
