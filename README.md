...
<img src="/images/logo.svg" width="96" alt="Four Score and More logo">
...
* Merged PRs, and other commits to the `master` branch, are automatically built and deployed to production.
