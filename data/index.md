...
- **[data.gov.uk (UK)](https://data.gov.uk)**  
  ...
  Some cities and regions also offer public data, e.g.,
  the [London Data Store](https://data.london.gov.uk/)
  traverses jobs, transport, and more.
